...
public class PedidoCreditoDTO {
  ...
  public ParecerOrigemPedidoDTO getParecerOrigemPedido() {
    return parecerOrigemPedido;
  }

  public void setParecerOrigemPedido(ParecerOrigemPedidoDTO parecerOrigemPedido) {
  ...
  @JsonProperty(value ="parecer_origem_pedido")
  private ParecerOrigemPedidoDTO parecerOrigemPedido; // o parecer da origem do pedido de crédito
