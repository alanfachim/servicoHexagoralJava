...
| Rota | Cenário de teste | Descrição | Dados de entrada | Dados de saída | Código de status | Mensagem de erro |
| --- | --- | --- | --- | ------ | --- | --- |
| GET /pedidos | Consultar todos os pedidos sem filtros | Verificar se a rota retorna todos os pedidos existentes no banco de dados | Nenhum | Uma lista de pedidos no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?codigoCliente=23345677906912 | Consultar pedidos por código do cliente | Verificar se a rota retorna os pedidos de um determinado cliente | codigoCliente=23345677906912 | Uma lista de pedidos do cliente 23345677906912 no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?nomeProduto=descricao_produto | Consultar pedidos por nome do produto | Verificar se a rota retorna os pedidos de um determinado produto | nomeProduto=descricao_produto | Uma lista de pedidos do produto descricao_produto no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?valorMinimo=1000&valorMaximo=5000 | Consultar pedidos por valor mínimo e máximo | Verificar se a rota retorna os pedidos que estão dentro de um intervalo de valor | valorMinimo=1000&valorMaximo=5000 | Uma lista de pedidos com valor entre 1000 e 5000 no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?dataInicio=2020-01-01&dataFim=2020-12-31 | Consultar pedidos por data de início e fim | Verificar se a rota retorna os pedidos que foram criados dentro de um período de tempo | dataInicio=2020-01-01&dataFim=2020-12-31 | Uma lista de pedidos com data entre 2020-01-01 e 2020-12-31 no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?status=APROVADO | Consultar pedidos por status | Verificar se a rota retorna os pedidos que têm um determinado status | status=APROVADO | Uma lista de pedidos com status APROVADO no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?sortBy=valorPedido | Consultar pedidos por ordenação | Verificar se a rota retorna os pedidos ordenados por um determinado campo | sortBy=valorPedido | Uma lista de pedidos ordenados pelo valor do pedido no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?pageSize=10&pageNumber=2 | Consultar pedidos por paginação | Verificar se a rota retorna os pedidos de uma determinada página com um determinado tamanho | pageSize=10&pageNumber=2 | Uma lista de 10 pedidos da segunda página no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos?codigoCliente=abc&nomeProduto=123&valorMinimo=-1&valorMaximo=0&dataInicio=31-02-2020&dataFim=01-01-2019&status=XYZ&sortBy=foo&pageSize=0&pageNumber=-1 | Consultar pedidos com parâmetros inválidos | Verificar se a rota retorna um erro quando os parâmetros são inválidos | codigoCliente=abc&nomeProduto=123&valorMinimo=-1&valorMaximo=0&dataInicio=31-02-2020&dataFim=01-01-2019&status=XYZ&sortBy=foo&pageSize=0&pageNumber=-1 | Nenhum | 400 (Bad Request) | Parâmetros inválidos |
| GET /pedidos/ccc9c52a-34cf-49da-ab31-bacef8f99234 | Consultar um pedido por código | Verificar se a rota retorna um pedido específico de acordo com o código informado | CodigoPedidoCredito=ccc9c52a-34cf-49da-ab31-bacef8f99234 | Um pedido com o código ccc9c52a-34cf-49da-ab31-bacef8f99234 no formato JSON | 200 (OK) | Nenhuma |
| GET /pedidos/11111111-1111-1111-1111-111111111111 | Consultar um pedido com código inexistente | Verificar se a rota retorna um erro quando o código não existe no banco de dados | CodigoPedidoCredito=11111111-1111-1111-1111-111111111111 | Nenhum | 404 (Not Found) | Pedido não encontrado |
| GET /pedidos/abc | Consultar um pedido com código inválido | Verificar se a rota retorna um erro quando o código é inválido | CodigoPedidoCredito=abc | Nenhum | 400 (Bad Request) | Código inválido |
| DELETE /pedidos/ccc9c52a-34cf-49da-ab31-bacef8f99234 | Deletar um pedido por código | Verificar se a rota deleta um pedido específico de acordo com o código informado | CodigoPedidoCredito=ccc9c52a-34cf-49da-ab31-bacef8f99234 | Nenhum | 204 (No Content) | Nenhuma |
| DELETE /pedidos/11111111-1111-1111-1111-111111111111 | Deletar um pedido com código inexistente | Verificar se a rota retorna um erro quando o código não existe no banco de dados | CodigoPedidoCredito=11111111-1111-1111-1111-111111111111 | Nenhum | 404 (Not Found) | Pedido não encontrado |
| DELETE /pedidos/abc | Deletar um pedido com código inválido | Verificar se a rota retorna um erro quando o código é inválido | CodigoPedidoCredito=abc | Nenhum | 400 (Bad Request) | Código inválido |
| PUT /pedidos/ccc9c52a-34cf-49da-ab31-bacef8f99234 | Atualizar um pedido por código | Verificar se a rota atualiza um pedido específico de acordo com o código e os dados informados | CodigoPedidoCredito=ccc9c52a-34cf-49da-ab31-bacef8f99234 e um objeto JSON com os dados a serem atualizados | O pedido atualizado no formato JSON | 200 (OK) | Nenhuma |
| PUT /pedidos/11111111-1111-1111-1111-111111111111 | Atualizar um pedido com código inexistente | Verificar se a rota retorna um erro quando o código não existe no banco de dados | CodigoPedidoCredito=11111111-1111-1111-1111-111111111111 e um objeto JSON com os dados a serem atualizados | Nenhum | 404 (Not Found) | Pedido não encontrado |
| PUT /pedidos/abc | Atualizar um pedido com código inválido | Verificar se a rota retorna um erro quando o código é inválido | CodigoPedidoCredito=abc e um objeto JSON com os dados a serem atualizados | Nenhum | 400 (Bad Request) | Código inválido |
| PUT /pedidos/ccc9c52a-34cf-49da-ab31-bacef8f99234 | Atualizar um pedido com dados inválidos | Verificar se a rota retorna um erro quando os dados são inválidos | CodigoPedidoCredito=ccc9c52a-34cf-49da-ab31-bacef8f99234 e um objeto JSON com dados inválidos | Nenhum | 400 (Bad Request) | Dados inválidos |
| POST /pedidos | Criar um novo pedido | Verificar se a rota cria um novo pedido de acordo com os dados informados | Um objeto JSON com os dados do novo pedido | O novo pedido criado no formato JSON | 201 (Created) | Nenhuma |
| POST /pedidos | Criar um novo pedido com dados inválidos | Verificar se a rota retorna um erro quando os dados são inválidos | Um objeto JSON com dados inválidos | Nenhum | 400 (Bad Request) | Dados inválidos |
| POST /pedidos/ccc9c52a-34cf-49da-ab31-bacef8f99234/eventos | Criar um novo evento para um pedido | Verificar se a rota cria um novo evento para um pedido existente de acordo com os dados informados | CodigoPedidoCredito=ccc9c52a-34cf-49da-ab31-bacef8f99234 e um objeto JSON com os dados do novo evento | O novo evento criado no formato JSON | 201 (Created) | Nenhuma |
|